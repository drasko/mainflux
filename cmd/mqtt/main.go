...
import (
	...
	adapter "github.com/mainflux/mainflux/mqtt"
...
const (
	...
	envPort      string = "MF_MQTT_ADAPTER_PORT"
...
func main() {
	...
	go func() {
		...
		logger.Info(fmt.Sprintf("MQTT adapter service started, exposed port %s", cfg.Port))
		errs <- adapter.ListenAndServe(p, api.MakeHandler(svc, cc))
	}()
